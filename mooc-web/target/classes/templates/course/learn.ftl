            ...
            <div class="main-course-left">
                <div class="course-info" style="border-bottom: none;">
                    ...
                    <div class="course-meta">
                        ...
                        <a href="" disabled="" class="learn-btn" >Study Learning</a>

                        <div class="static-item">
                            <div class="meta">Difficulty Levels
                        ...
                        <div class="static-item">
                            <div class="meta">Length of the Course</div>
                    ...
                    <ul class="nav nav-tabs" style="padding-top: 25px;">
                        <li class="tabSelect active">
                            <a  href="javascript:void(0)" >
                                <span onclick="showTab(this,'courseSection')" data-target="courseSection" class="menu-item cur">Chapters</span>
                            </a>
                        </li>
                        <li class="tabSelect">
                            <a  href="javascript:void(0)" >
                                <span onclick="showTab(this,'comment')" data-target="comment" class="menu-item">Comments</span>
                            </a>
                        </li>
                    </ul>
                </div>

                <!-- Chapter Information - start -->
